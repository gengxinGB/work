...
export default {
    ...
    methods: {
            ...
            console.log(data)
              this.axios.post('cusProInfo/buyNow',this.qs.stringify(data)).then(response=>{
                  ...
                  if(response.data.success==true){
                        ...
                        console.log(this.productId+"产品id")
        ...
        inshopyourselforder:function(){
            this.$router.push({path:'/buynowyourself',query:{productSkuId:this.$route.query.productSkuId,productAmount:this.$route.query.productAmount}})
        }
    },
